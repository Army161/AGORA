...
[![Tests](https://img.shields.io/badge/tests-52%20passing-brightgreen.svg)](tests/test_store.py)
...
52 tests covering lease expiry, lock contention, handoff lifecycle, message targeting,
